...
{{--    </header>--}}
        ...
        <div class="modal-container bg-white w-full h-full mx-auto rounded-none shadow-lg z-50">
            <div class="modal-content py-4 text-left px-6 h-full flex flex-col">
                ...
                <div class="py-4 flex-grow overflow-auto">
                    <form id="gallery-form" class="space-y-4 md:max-w-3xl md:mx-auto" enctype="multipart/form-data">
        ...
        <div class="modal-container bg-white w-full h-full mx-auto rounded-none shadow-lg z-50">
            <div class="modal-content py-4 text-left px-6 h-full flex flex-col">
                ...
                <div class="flex justify-between items-center pb-3 border-b">
                    ...
                    <div class="flex items-center space-x-2">
                        <div class="hidden md:block text-xs text-gray-500">
                            Press <span class="key-hint">F</span> for fullscreen, <span class="key-hint">ESC</span> to close
                        </div>
                        <button class="modal-close cursor-pointer z-50">
                            <svg class="fill-current text-gray-500 hover:text-gray-800" xmlns="http://www.w3.org/2000/svg"
                                 width="24" height="24" viewBox="0 0 18 18">
                ...
                <div class="py-4 flex-grow overflow-auto flex flex-col">
                    <div id="preview-image-container" class="relative mb-4 flex-grow flex items-center justify-center group">
                        <img id="preview-image" src="" alt="Preview"
                             class="max-h-[70vh] w-auto object-contain mx-auto">
                        <!-- Only one fullscreen button that only appears on hover -->
                        <button id="preview-fullscreen-toggle"
                                class="absolute top-2 right-2 p-2 bg-gray-800 bg-opacity-50 rounded-full text-white hover:bg-opacity-70 focus:outline-none opacity-0 transition-opacity duration-200 group-hover:opacity-100 hover:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5v-4m0 4h-4m4 0l-5-5" />
                            </svg>
                        </button>
                    </div>
                    <div class="bg-white md:max-w-3xl md:mx-auto w-full">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-red-700">
                                    Are you sure you want to delete "<span id="delete-image-title"
    ...
    @push('styles')
        ...
        <style>
            ...
            /* Make the preview container a hover target */
            #preview-image-container {
                position: relative;
                transition: all 0.3s ease;
            }

            /* Hide fullscreen button by default */
            #preview-fullscreen-toggle {
                opacity: 0;
                transition: opacity 0.2s ease;
            }

            /* Show fullscreen button on container hover */
            #preview-image-container:hover #preview-fullscreen-toggle {
                opacity: 0.8;
            }

            /* Explicit hover on the button itself */
            #preview-fullscreen-toggle:hover {
                opacity: 1;
            }

            /* Ensure no duplicate buttons are shown */
            .modal-header-fullscreen-button {
                display: none !important;
            }

            /* Custom header indicators should be hidden in our fullscreen mode */
            body.fullscreen-active .header-indicator {
                display: none !important;
            }
        </style>
    @endpush
