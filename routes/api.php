...
Route::middleware('api.secure')->group(function () {
    ...
    Route::get('/parent-only', [InsightCategoryController::class, 'showAllCategory'])
        ->defaults('parent_only', true);

// Get subcategories of a specific parent
    Route::get('/{id}/subcategories', [InsightCategoryController::class, 'getSubcategories']);

// Update the order of categories
    Route::post('/update-order', [InsightCategoryController::class, 'updateCategoriesOrder']);
    ...
    Route::get('/top-insights', [App\Http\Controllers\Web\TopInsightsController::class, 'getTopInsights']);
});
